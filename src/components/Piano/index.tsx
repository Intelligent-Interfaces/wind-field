    ...
    <PianoStyles>
      <PianoBlackKeys>
        ...
        <Slot placement="1 / 1 / span 1 / span 4">
          <Grid columns={8}>
            <Slot placement="1 / 1 / span 1 / span 3">
              <PianoKey keyCode="Digit1" pl={60} octave={octave - 1} color="#B78963;" note="F#" />
            </Slot>
            <Slot placement="1 / 4 / span 1 / span 2">
              <PianoKey keyCode="Digit2" color="#B78963;" octave={octave - 1} note="G#" />
            </Slot>
            <Slot placement="1 / 6 / span 1 / span 3">
              <PianoKey keyCode="Digit3" pr={60} color="#B78963;" octave={octave - 1} note="A#" />
            </Slot>
          </Grid>
        </Slot>
        ...
        <Slot placement="1 / 5 / span 1 / span 3">
          <Grid columns={6}>
            <Slot placement="1 / 1 / span 1 / span 3">
              <PianoKey keyCode="Digit5" pl={60} color="#B78963;" octave={octave} note="C#" />
            </Slot>
            <Slot placement="1 / 4 / span 1 / span 3">
              <PianoKey keyCode="Digit6" pr={60} color="#B78963;" octave={octave} note="D#" />
            </Slot>
          </Grid>
        </Slot>
        ...
        <Slot placement="1 / 8 / span 1 / span 4">
          <Grid columns={8}>
            <Slot placement="1 / 1 / span 1 / span 3">
              <PianoKey keyCode="Digit7" pl={60} color="#B78963;" octave={octave} note="F#" />
            </Slot>
            <Slot placement="1 / 4 / span 1 / span 2">
              <PianoKey keyCode="Digit8" color="#B78963;" octave={octave} note="G#" />
            </Slot>
            <Slot placement="1 / 6 / span 1 / span 3">
              <PianoKey keyCode="Digit9" pr={60} color="#B78963;" octave={octave} note="A#" />
            </Slot>
          </Grid>
        </Slot>
        ...
        <Slot placement="1 / 12 / span 1 / span 3">
          <Grid columns={6}>
            <Slot placement="1 / 1 / span 1 / span 3">
              <PianoKey keyCode="Minus" pl={60} color="#B78963;" octave={octave + 1} note="C#" />
            </Slot>
            <Slot placement="1 / 4 / span 1 / span 3">
              <PianoKey keyCode="Equal" pr={60} color="#B78963;" octave={octave + 1} note="D#" />
            </Slot>
          </Grid>
        </Slot>
      </PianoBlackKeys>
